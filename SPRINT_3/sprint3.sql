...
-- FEM ELS INSERT INTO DE credit card
...
-- Editem les relacions de transaction amb credit_card
...
SELECT company.company_name, company.phone, company.country, AVG(transaction.amount) AS avg_transaction
FROM company
...
SELECT * FROM transactions.vistamarketing WHERE country = 'Germany';
...
INSERT INTO user (id, name, surname, phone, email, birth_date, country, city, postal_code, address) VALUES (        "9999", "Pepito", "de los Palotes", "1-282-281-0551", "peponm@protonmail.edu", "Nov 17, 1785",         "United States", "Lowell", "73544", "348-7818 Sagittis St.");
...
SELECT transaction.id as id_transaction, data_user.name as nom_usuari, data_user.surname as cognom, credit_card.iban, company.company_name AS nom_empresa
FROM transaction
JOIN company ON transaction.company_id = company.id
JOIN data_user ON transaction.user_id = data_user.id
JOIN credit_card ON transaction.credit_card_id = credit_card.id
GROUP BY id_transaction, nom_usuari, cognom, iban, nom_empresa
